...
var packageBody,ground, Boxleft, Boxright, boxmid;
...
function setup() {
	...
	boxmid = createSprite(375, 650, 200, 20);
	boxmid.shapeColor = color(255, 0, 0);
	...
	boxmid = Bodies.rectangle(375, 650, 200, 20, {isStatic:true});
